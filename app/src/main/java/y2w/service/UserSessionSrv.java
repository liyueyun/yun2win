...
public class UserSessionSrv {
    ...
    public void sync(String token, String userId, Back.Result<List<UserSessionEntity>> result){
        ClientFactory.getInstance().getUserSessionsList(token, userId, result);
    }
}
